...
if __name__ == "__main__":
    ...
    #optim = torch.optim.SGD(nn.parameters()), lr=1e-4)
    optim = torch.optim.SGD(it.chain(nn.nn1.parameters(), nn.nn2.parameters()), lr=1e-4)
    ...
    for i in range(5000):
        ...
        loss = loss_f(y, y_pred) + loss_glue
        loss.backward()
        optim.step()
    ...
    plt.savefig('plots/test_together.png')
    plt.show()
