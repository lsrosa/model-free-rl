...
print("Running value:", network.value_module(env.reset()))

collector = SyncDataCollector(
    env,
    network.policy_module,
...
loss_module = ClipPPOLoss(
    actor_network=network.policy_module,
    critic_network=network.value_module,
...
for i, tensordict_data in enumerate(collector):
    ...
    if i % 10 == 0:
        ...
        with set_exploration_type(ExplorationType.MEAN), torch.no_grad():
            ...
            eval_rollout = env.rollout(1000, network.policy_module)
